...
#ifndef LWM2M_Event_Data_Delivery_OBJECT_BASE_H_
#define LWM2M_Event_Data_Delivery_OBJECT_BASE_H_

#include "lwm2m_object_base.h"
#include "lwm2m_object_options.h"

#ifndef MAX_Event_Data_Delivery_INSTANCES
#define MAX_Event_Data_Delivery_INSTANCES 2
#endif

#if CONFIG_Event_Data_Delivery_Name_OPTION == 1
#ifndef MAX_Event_Data_Delivery_Name
#define MAX_Event_Data_Delivery_Name 64
#endif
#endif

typedef enum Event_Data_Delivery_resources_t
{
#if CONFIG_Event_Data_Delivery_Name_OPTION == 1
  Event_Data_Delivery_Name_id = 0, 
#endif
#if CONFIG_Event_Data_Delivery_Event_Data_Links_OPTION == 1
  Event_Data_Delivery_Event_Data_Links_id = 1, 
#endif
#if CONFIG_Event_Data_Delivery_Latest_Eventlog_OPTION == 1
  Event_Data_Delivery_Latest_Eventlog_id = 2, 
#endif
#if CONFIG_Event_Data_Delivery_Schedule_OPTION == 1
  Event_Data_Delivery_Schedule_id = 3, 
#endif
} 
Event_Data_Delivery_resources_t;
 ...
 */
lwm2m_object_t *Event_Data_Delivery_initialise(void);
 ...
 * MAX_Event_Data_Delivery_INSTANCES before including 
 * Event_Data_Delivery_generated_object.h to increase the number of available 
 * instances.
 */
uint8_t Event_Data_Delivery_create_instance(uint16_t instance);

/*
 * Delete the specified Event_Data_Delivery instance. Returns COAP_404_NOT_FOUND if
 * the instance id is not found.
 */
__attribute__((weak)) uint8_t Event_Data_Delivery_delete_instance(uint16_t instance);
 ...
 */ 
__attribute__((weak)) void Event_Data_Delivery_register_instance(uint16_t instance);

/*
 * Unregisters the instance from the lwm2m engine, must be called after register
 */ 
__attribute__((weak)) void Event_Data_Delivery_unregister_instance(uint16_t instance);


/*
 * Override this function to perform actions on the creation of an instance
 */
__attribute__((weak)) void Event_Data_Delivery_instance_created(uint16_t instance);

/*
 * This function is called when the server has written a new value to ANY
 * writeable resource
 */
void Event_Data_Delivery_changed(uint16_t instance);
 ...
 * resource. Note the global Event_Data_Delivery_changed function is also called.
 * 
...
#if CONFIG_Event_Data_Delivery_Name_OPTION == 1
uint8_t Event_Data_Delivery_Name_get(uint16_t instance,  const char **val);


#endif
#if CONFIG_Event_Data_Delivery_Name_OPTION == 1
uint8_t Event_Data_Delivery_Name_set(uint16_t instance,  const char *val, size_t length, bool notify);
#endif
  
#if CONFIG_Event_Data_Delivery_Name_OPTION == 1
uint8_t Event_Data_Delivery_Name_changed(uint16_t instance);
#endif
  
bool Event_Data_Delivery_Event_Data_Links_is_set(uint16_t instance, uint16_t resource_instance);                                                                    

#if CONFIG_Event_Data_Delivery_Event_Data_Links_OPTION == 1
uint8_t Event_Data_Delivery_Event_Data_Links_get(uint16_t instance, uint16_t resource_instance, lwm2m_object_link_t *val);


#endif
#if CONFIG_Event_Data_Delivery_Event_Data_Links_OPTION == 1
uint8_t Event_Data_Delivery_Event_Data_Links_set(uint16_t instance, uint16_t resource_instance, lwm2m_object_link_t val, bool notify);
#endif
  
#if CONFIG_Event_Data_Delivery_Event_Data_Links_OPTION == 1
uint8_t Event_Data_Delivery_Event_Data_Links_changed(uint16_t instance);
#endif
  
bool Event_Data_Delivery_Latest_Eventlog_is_set(uint16_t instance, uint16_t resource_instance);                                                                    

#if CONFIG_Event_Data_Delivery_Latest_Eventlog_OPTION == 1
uint8_t Event_Data_Delivery_Latest_Eventlog_get(uint16_t instance, uint16_t resource_instance, uint8_t ** buffer, size_t *length);


#endif
#if CONFIG_Event_Data_Delivery_Latest_Eventlog_OPTION == 1
uint8_t Event_Data_Delivery_Latest_Eventlog_set(uint16_t instance, uint16_t resource_instance, uint8_t* val, size_t length, bool notify);
#endif

#if CONFIG_Event_Data_Delivery_Schedule_OPTION == 1
uint8_t Event_Data_Delivery_Schedule_get(uint16_t instance,  lwm2m_object_link_t *val);


#endif
#if CONFIG_Event_Data_Delivery_Schedule_OPTION == 1
uint8_t Event_Data_Delivery_Schedule_set(uint16_t instance,  lwm2m_object_link_t val, bool notify);
#endif
